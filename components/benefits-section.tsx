          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <motion.article
                ...
                className="flex flex-col rounded-3xl bg-card p-8 shadow-[0_2px_24px_rgba(0,0,0,0.04)] ring-1 ring-border/50 transition-shadow duration-500 hover:shadow-[0_8px_40px_rgba(0,0,0,0.08)] md:p-10"
              >
                <Icon
                  ...
                  aria-hidden="true"
                />
                <h3 className="mt-8 font-serif text-2xl font-medium tracking-tight text-foreground md:text-[1.75rem]">
                  {benefit.title}
                </h3>
                <p className="mt-4 text-pretty text-[0.95rem] font-light leading-relaxed text-muted-foreground">
                  {benefit.description}
                </p>
              </motion.article>
            )
