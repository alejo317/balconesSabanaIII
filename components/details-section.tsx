...
const details: Detail[] = [
  ...
  },
  {
    ...
    label: "Parqueaderos",
    value: "3",
    note: "Gran espacio para visitantes y familiares",
  },
  {
    icon: Compass,
    label: "Estado de obra",
    value: "Entrega inmediata",
    note: "Sin demoras ni trámites engorrosos, listo para habitar",
  },
  {
    icon: Layers,
    label: "Acabados",
    value: "A elección",
    note: "Sientase libre de escoger entre varias opciones de acabados y materiales segun su estilo y gusto personal",
    wide: true,
  },
  {
    icon: Droplets,
    label: "Servicios",
    value: "Completos",
    note: "Tanques de reserva, energía, gas natural y seguridad inteligente",
    wide: true,
  },
]
